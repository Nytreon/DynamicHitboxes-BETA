...
`);
   ...
   `;
    ...
    duration({message}) {
        ...
        world.sendMessage("Hitbox watch duration has been set to: " + newJobDuration);
    },
    refresh({message}) {
        let newRefreshRate = parseInt(message) || settings.get("refreshRate");
        settings.set("refreshRate", newRefreshRate);
        world.sendMessage("Dynamic entity hitbox refresh rate has been set to: " + newRefreshRate);
    },
    toggle(_) {
    ...
    radius({message}) {
        ...
        world.sendMessage("Hitbox viewing radius has been set to: " + newEntityScanRadius);
    },
    ...
    maxCount({message}) {
        ...
        world.sendMessage("Max entity bounds per player set to: " + newMaxEntityCount);
    },
    includePlayers(_) {
